"""update message constraint for is_deleted
...
def upgrade() -> None:
    # This migration was to update the constraint after adding 'is_deleted'
    # It might have been overwritten by a later migration with the same name.
    # We ensure the correct constraint is in place.
